...
- **Status:** **RESOLVED 2026-06-13 (Option A) — UNBLOCKS TASK-0002/0003.** The kernel built the
  ...
  written. (Was: NEEDS-DECISION (owner / kernel team) — blocked TASK-0002, Epic A.) A concurrent
  `meta/handoff` session also shipped `hf drift` + `hf policy` + `FLEET_GUIDE.md` (commit `000e4c0`,
  `feat/drift-policy-fleetguide`) alongside PR #17 — read `meta/handoff/FLEET_GUIDE.md` before use.
